...
// `currentColor` for stroke, so it tints with the surrounding text color — the
// active nav tab turns MIT red for free, dark/light mode just works. Pure
// presentational component: no hooks, safe in both server and client files.
//
